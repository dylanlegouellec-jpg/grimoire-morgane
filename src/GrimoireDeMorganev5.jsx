...
function PortionWheel({ value, onChange, min = 1, max = 24 }) {
  ...
  return (
    <div className="portion-wheel-wrap">
      ...
      <span className="portion-wheel-suffix">pers.</span>
    </div>
  );
}
  ...
  return (
    <div className="cookmode-backdrop">
      <div className="cookmode cookmode-list">
        ...
        <div className="cookmode-portions">
          <span className="cookmode-portions-label"><Users size={13} /> Portions</span>
          <PortionWheel value={servings} onChange={setServings} />
        </div>
...
/* --- Molette de portions (mode cuisine) --- */
.cookmode-portions {
  flex-shrink: 0;
  display: flex; flex-direction: column; align-items: center; gap: 2px;
}
.cookmode-portions-label {
  display: inline-flex; align-items: center; gap: 6px;
  font-family: 'Cinzel', serif; font-size: 0.68rem; letter-spacing: 1px; text-transform: uppercase;
