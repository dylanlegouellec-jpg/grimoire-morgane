...
const MEAL_TYPE_BY_KEY = MEAL_TYPES.reduce<Record<string, MealTypeInfo>>((acc, m) => { acc[m.key] = m; return acc; }, {});
export function mealTypeInfo(key: string): MealTypeInfo {
...
export const COURSE_TYPES: MealTypeInfo[] = [
...
const COURSE_TYPE_BY_KEY = COURSE_TYPES.reduce<Record<string, MealTypeInfo>>((acc, c) => { acc[c.key] = c; return acc; }, {});
export function courseTypeInfo(key: string): MealTypeInfo {
...
export function mealTypeHasCourse(mealTypeKey: string): boolean {
...
export function courseTypeOrder(key: string | null | undefined): number {
...
export function formatWeekRange(weekStart: Date, language: string | null | undefined): string {
...
export function formatDayLabel(date: Date, language: string | null | undefined): string {
